...
- [Implementing the contract](docs/implementing.md) — what "done" means for an implementation (agents get it as a [skill](skills/implement-pizza-service/SKILL.md), installable anywhere via `/plugin marketplace add hungovercoders/pizza-pattern`)
